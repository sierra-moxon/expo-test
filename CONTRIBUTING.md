# Contributing to expo-test

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
expo-test. These guidelines are not strict rules.
...
The expo-test team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the expo-test technical leads
...
[issues]: https://github.com/sierra-moxon/expo-test/issues/
[pulls]: https://github.com/sierra-moxon/expo-test/pulls/
